...
<div class="heading" style="background:url(88.jpg) no-repeat">
        <h1>Honeymoon</h1>
    </div>
...
<section class="booking">
    ...
    <form action="honeymoon_table" method="post" class="book-form">
...
<section class="footer">
    ...
    <div class="credit">created by <span>Isa Sadiq Ahmad</span> | all right reserved! </div>
