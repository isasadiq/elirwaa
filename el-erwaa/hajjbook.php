...
<div class="heading" style="background:url(300.jpg) no-repeat">
        <h1> Hajj & Umrah</h1>
    </div>
...
<section class="booking">
    ...
    <form action="hajj_table.php" method="post" class="book-form">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>umra or hajj :</span>
                <input type="text" placeholder="type of trip  " name="location">
            </div>
            <div class="inputBox">
                <span>how many :</span>
